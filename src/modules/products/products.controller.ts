...
export class ProductsController {
  ...
  @ApiResponse({
    status: 200,
    description: 'Возврат списка товаров по заданным параметрам',
    type: [ProductDto],
  })
  @Get()
  ...
  @ApiOperation({ summary: 'Обновить определённый товар' })
  @ApiParam({
    name: 'id',
    required: true,
    type: String,
  ...
  @ApiResponse({
    status: 200,
    description: 'Товар с заданным id обновлён',
  })
  @Put(':id')
  ...
  @ApiOperation({ summary: 'Удалить определённый товар' })
  @ApiParam({
    name: 'id',
    required: true,
    type: String,
  ...
  @ApiResponse({
    status: 200,
    description: 'Товар с заданным id удалён',
  })
  @Delete(':id')
